...
//*******************************************************************************************
function listeVille($all = false)
{
	$retour = array();
	try {
		$madb = new PDO('sqlite:bdd/IUT.sqlite');
		$requete = "select distinct Commune, villes.insee from utilisateurs inner join villes on villes.insee = utilisateurs.insee";
		if ($all)
			$requete = "select distinct Commune,insee from villes";
